...
\begin{itemize}
    ...
    \item RQ2: Can we design expressive generative models capable of generating relational data with complex structural dependencies without any implicit independence assumptions?
    \item RQ3: Can we train tractable yet expressive generative models for tabular data?
\end{itemize}
